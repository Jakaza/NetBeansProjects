                                ...
                                <form action="#" method="post" class="custom-form booking-form" id="bb-booking-form" role="form">
                                    ...
                                    <div class="booking-form-body">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6 col-12">
                                                <input type="tel" class="form-control" name="bb-phone" placeholder="Mobile 071-177-0422" pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}" required="">
                                            </div>
                                            ...
                                            <div class="col-lg-6 col-12">
                                                <select class="form-select form-control" name="bb-branch" id="bb-branch" aria-label="Default select example">
                                                    ...
                                                    <option value="Grünberger">Pretoria</option>
                                                    <option value="Behrenstraße">Johannesburg</option>
                                                    <option value="Weinbergsweg">Cape Town</option>
                                                    <option value="Weinbergsweg">Durban</option>
                                                </select>
